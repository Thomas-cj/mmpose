...
param_scheduler = [
    dict(begin=0, by_epoch=False, end=5, start_factor=0.001, type='LinearLR'),
    dict(
        begin=0,
        by_epoch=True,
        end=5,
...
test_evaluator = dict(
    ann_file='data/Swim_DK_small/annotations/SwimDK_small_val.json',
    type='CocoMetric')
...
work_dir = './work_dirs\\td-hm_hrnet-w32_8xb64-210e_coco-1528x7164_custom'
